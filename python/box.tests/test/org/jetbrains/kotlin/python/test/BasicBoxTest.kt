...
import org.jetbrains.kotlin.py.facade.K2JSTranslator
import org.jetbrains.kotlin.py.facade.MainCallParameters
import org.jetbrains.kotlin.py.facade.TranslationResult
...
abstract class BasicBoxTest(
    ...
    protected open fun translateFiles(
        ...
        val outputFiles = translationResult.getOutputFiles(outputFile)
