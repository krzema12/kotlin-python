...
actual inline fun <T> Array<out T>.copyOf(): Array<T> {
...
actual fun <T> Array<out T>.copyOf(newSize: Int): Array<T?> {
    require(newSize >= 0) { "Invalid new array size: $newSize." }
 ...
 */
@Suppress("ACTUAL_WITHOUT_EXPECT")
actual fun <T> Array<out T>.copyOfRange(fromIndex: Int, toIndex: Int): Array<T> {
...
@SinceKotlin("1.3")
@Suppress("ACTUAL_FUNCTION_WITH_DEFAULT_ARGUMENTS")
actual fun <T> Array<T>.fill(element: T, fromIndex: Int = 0, toIndex: Int = size): Unit {
    AbstractList.checkRangeIndexes(fromIndex, toIndex, size)
 ...
 */
@Suppress("ACTUAL_WITHOUT_EXPECT", "NOTHING_TO_INLINE")
actual inline operator fun <T> Array<out T>.plus(element: T): Array<T> {
 ...
 */
@Suppress("ACTUAL_WITHOUT_EXPECT")
actual operator fun <T> Array<out T>.plus(elements: Collection<T>): Array<T> {
 ...
 */
@Suppress("ACTUAL_WITHOUT_EXPECT", "NOTHING_TO_INLINE")
actual inline operator fun <T> Array<out T>.plus(elements: Array<out T>): Array<T> {
 ...
 */
@Suppress("ACTUAL_WITHOUT_EXPECT", "NOTHING_TO_INLINE")
actual inline fun <T> Array<out T>.plusElement(element: T): Array<T> {
    return this.asDynamic().concat(arrayOf(element))
}
 ...
 * @sample samples.collections.Arrays.Sorting.sortArray
 */
actual fun LongArray.sort(): Unit {
 ...
 * @sample samples.collections.Arrays.Sorting.sortArray
 */
actual fun ByteArray.sort(): Unit {
    this.asDynamic().sort()
}
 ...
 * @sample samples.collections.Arrays.Sorting.sortArray
 */
actual fun ShortArray.sort(): Unit {
    this.asDynamic().sort()
}
 ...
 * @sample samples.collections.Arrays.Sorting.sortArray
 */
actual fun DoubleArray.sort(): Unit {
    this.asDynamic().sort()
}
 ...
 * @sample samples.collections.Arrays.Sorting.sortArray
 */
actual fun FloatArray.sort(): Unit {
    this.asDynamic().sort()
}
 ...
 * @sample samples.collections.Arrays.Sorting.sortArray
 */
actual fun CharArray.sort(): Unit {
...
fun <T> Array<out T>.sort(comparison: (a: T, b: T) -> Int): Unit {
...
@DeprecatedSinceKotlin(warningSince = "1.6")
@kotlin.internal.InlineOnly
inline fun ByteArray.sort(noinline comparison: (a: Byte, b: Byte) -> Int): Unit {
...
@DeprecatedSinceKotlin(warningSince = "1.6")
@kotlin.internal.InlineOnly
inline fun ShortArray.sort(noinline comparison: (a: Short, b: Short) -> Int): Unit {
    asDynamic().sort(comparison)
}
...
@DeprecatedSinceKotlin(warningSince = "1.6")
@kotlin.internal.InlineOnly
inline fun IntArray.sort(noinline comparison: (a: Int, b: Int) -> Int): Unit {
    asDynamic().sort(comparison)
}
...
@DeprecatedSinceKotlin(warningSince = "1.6")
@kotlin.internal.InlineOnly
inline fun LongArray.sort(noinline comparison: (a: Long, b: Long) -> Int): Unit {
    asDynamic().sort(comparison)
}
...
@DeprecatedSinceKotlin(warningSince = "1.6")
@kotlin.internal.InlineOnly
inline fun FloatArray.sort(noinline comparison: (a: Float, b: Float) -> Int): Unit {
    asDynamic().sort(comparison)
}
...
@DeprecatedSinceKotlin(warningSince = "1.6")
@kotlin.internal.InlineOnly
inline fun DoubleArray.sort(noinline comparison: (a: Double, b: Double) -> Int): Unit {
    asDynamic().sort(comparison)
}
...
@DeprecatedSinceKotlin(warningSince = "1.6")
@kotlin.internal.InlineOnly
inline fun CharArray.sort(noinline comparison: (a: Char, b: Char) -> Int): Unit {
    asDynamic().sort(comparison)
}
 ...
 * The sort is _stable_. It means that equal elements preserve their order relative to each other after sorting.
 */
actual fun <T> Array<out T>.sortWith(comparator: Comparator<in T>): Unit {
...
@SinceKotlin("1.4")
@Suppress("ACTUAL_FUNCTION_WITH_DEFAULT_ARGUMENTS")
actual fun <T> Array<out T>.sortWith(comparator: Comparator<in T>, fromIndex: Int = 0, toIndex: Int = size): Unit {
    AbstractList.checkRangeIndexes(fromIndex, toIndex, size)
